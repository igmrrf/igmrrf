  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hello, I'm the AI Architect for The LDO. Ask me anything about his architectural decisions, technical trade-offs, or specific case studies like BugRelay.",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, I'm having trouble connecting to the RAG pipeline right now.",
        },
      ]);
    } finally {
      setIsLoading(false);
  ...
  return (
    <div className="flex flex-col h-[70vh] max-w-4xl mx-auto border border-border rounded-3xl bg-background overflow-hidden shadow-2xl">
      ...
      <form
        ...
        className="p-6 border-t border-border bg-muted/30 flex gap-4 items-center"
      >
        <input
          type="text"
          value={input}
