      ...
      >
        ...
        <section className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8 flex flex-col gap-8 relative">
            ...
            <motion.h1
              variants={item}
              className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-[0.85]"
            >
              Decentralized <br />
              <span className="text-primary not-italic">Distribution</span> &{" "}
              <br />
              Scale.
            </motion.h1>
            <motion.p
          ...
          >
            ...
            <div className="flex flex-col gap-2 text-sm font-bold">
              <span className="hover:text-primary cursor-default transition-colors">
                01. WEB3_DISTRIBUTION
              </span>
              <span className="hover:text-primary cursor-default transition-colors">
                02. TYPESCRIPT_STRICT
              </span>
              <span className="hover:text-primary cursor-default transition-colors">
                03. NEOVIM_TUI_MAXIMALISM
              </span>
              <span className="hover:text-primary cursor-default transition-colors">
                04. SUPPLY_CHAIN_LOGISTICS
              </span>
            </div>
          </motion.div>
        </section>
        ...
        {/* Expertise Grid */}
        <section
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-t border-l border-border"
