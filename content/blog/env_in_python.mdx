...
summary: "Before we begin let's look at our little vocabulary: ENV = Environmental Variable, ENVs = Environmental Variables. A guide on using ENVs for automation and security in Python scripts."
date: "2020-01-01"
tags: ["env", "python"]
featured: false
---
