---
title: "socks-ssh: Correct Security That Breaks Local Development"
...
On npm as `socks-ssh`; source, redaction defaults and host-key pinning at **[github.com/igmrrf/socks-ssh](https://github.com/igmrrf/socks-ssh)**. Also written up as a [case study](/case-studies/socks-ssh).
